...
@section('content')
    ...
    <div
        ...
        <div style="flex-grow: 1;">
            <span style="font-size: 50px;">UI/UX</span>
        </div>
    ...
    <div style="padding-left: 100px; padding-right: 100px;  padding-top:20px">
        {{-- tabel --}}
        <table style="border: 3px solid #000 !important;" class="table table-bordered" id="tabelUIUX">
            <thead>
                <tr>
                    <th style="text-align: center" scope="col">No</th>
                    <th style="text-align: center" scope="col">Nama Tim</th>
                    <th style="text-align: center" scope="col">Ketua</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{
                        ($account->students->where('status', 'ketua')->first() == null) ? "-" : $account->students->where('status', 'ketua')->first()->nama
                    }}</td>
                    ...
                    @if ($account->students->first() != null)
                        ...
                        @if ($account->students->first()->sertifikat == 'sudah')
                            <td style="text-align: center">
                                <a class="team-name" href="/admin/{{ $account->id }}/info" style="text-decoration: none;color:black">
                                    1/1
                                </a>
                            </td>
                        @else
    ...
    <script>
        function filter() {
            ...
            filter = input.value;
            table = document.getElementById("tabelUIUX");
